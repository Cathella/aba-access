    ...
    <div className="min-h-screen bg-brand-neutral-100 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto pb-[80px] flex items-center justify-center">
        <div className="px-5 flex flex-col items-center">
          {/* ── Icon (error/neutral: muted circle with neutral Ban icon) ── */}
          ...
          <div className="w-full bg-brand-neutral-0 border border-brand-neutral-200 rounded-2xl p-4 mb-3 space-y-2.5">
            ...
            <div className="flex items-center justify-between">
              ...
              <span
                className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] bg-brand-neutral-200 text-brand-neutral-700"
                style={{ fontWeight: 500 }}
              >
                Declined
              </span>
            ...
            {reason && (
              <div className="flex items-center justify-between">
                ...
                <span
                  className="text-[12px] text-brand-neutral-900 text-right max-w-[180px]"
                  style={{ fontWeight: 500 }}
                >
                  {reason}
                </span>
          ...
          <div className="w-full bg-brand-neutral-100 border border-brand-neutral-200 rounded-2xl px-4 py-3 flex items-start gap-2.5 mb-8">
            ...
            <p
              ...
              style={{ fontWeight: 400 }}
            >
              This decision has been logged. The facility has been notified that
              no package coverage will be applied.
            </p>
          </div>
